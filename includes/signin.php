					...
					<div class="login">
						<div class="login-right">
							<form method="post">
								...
								<input type="text" name="email" id="email" placeholder="Enter your Email"  required="" style="color: #000000;">	
								<input type="password" name="password" id="password" placeholder="Password" value="" required="" style="color: #000000;">	
